...
async function Proximo() {
    if (this.x < 150) {
        ...
        await InserirImagem(antes, depois, img, nome, imagemAntes, imagemDepois)
        document.getElementById('carregar').style.display = 'none'
        VerificarNome()
    } else if (this.x == 150) {
        this.x += 1
        BuscarID()
        var imagemAntes = 'imagem/' + 150 + '.webp'
...
function BuscarID() {
    return antes = document.getElementById('imageAnterior'),
        depois = document.getElementById('imageProximo'),
        img = document.getElementById('image')
}

function InserirImagem(antes, depois, img, nome, imagemAntes, imagemDepois) {
    img.src = nome
    antes.src = imagemAntes
    depois.src = imagemDepois
}
